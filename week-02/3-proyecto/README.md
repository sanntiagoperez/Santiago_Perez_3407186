...
```
===========================
FICHA DE DATOS: APP DE MUSICA Y PODCASTS
===========================

Nombre:    Condenado al exito 2
Categoría: Reggaetón / Trap
Reproducciones: 34000000
Disponible: true
...
--- Conversiones ---
Reproducciones como texto: 34000000
typeof (convertido): string

--- Valor nulo ---
Valor pendiente: null
typeof null: object
¿Es null?: true
