...
// Dominio: [APP DE MUSICA Y PODCASTS]
// ============================================
//
// INSTRUCCIONES:
...
const items = [
  ...
  { name: "Condenado Al Exito II", category: "song", value: 61000000 },
  { name: "Ex sicario rompe el silencio sobre carmen salinas", category: "podcast", value: 289000000 },
  { name: "Yo sé", category: "song", value: 150000000 },
  { name: "Nunca te lleves nada de a basura", category: "podcast", value: 87000000 },
  { name: "E.M.H.D.M", category: "song", value: 3300000000 },
  { name: "Lo que naide te dice sobre ser disciplinado", category: "podcast", value: 8000000 },
  { name: "Pico y Chao", category: "song", value: 53000000 },
  { name: "Bosques siniestros, iglesia malditas y afecciones demonicas", category: "podcast", value: 87000000 },
  { name: "4.4.4", category: "song", value: 354000000 },
  { name: "F*cksNews: El niño satena", category: "podcast", value: 423000000 },
];
...
const valueLabel = "reproducciones"; // ← cambiar
...
for (let i = 0; i < items.length; i++) {
  ...
  const comparison = 
  item.value >= averageValue ? "sobre el promedio" : "bajo el promedio" // TODO: "sobre el promedio" o "bajo el promedio"
