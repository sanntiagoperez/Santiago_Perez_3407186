...
const DOMAIN_NAME = "App de Musica y Podcasts"; // TODO: Cambia el nombre del dominio
const VALUE_LABEL = "reporducciones"; // Ej: "precio", "cantidad", "duración"
...
const items = [
  ...
  {id: 1, name: "Condenado Al Exito II", category: "song", value: 61000000, active: true},
  {id: 2, name: "Yo se", category: "song", value: 150000000, active: true},
  {id: 3, name: "Ex sicario rompe el silencio", category: "podcast", value: 289000000, active: true},
  {id: 4, name: "Nunca te lleves nada de la basura", category: "podcast", value: 87000000, active: true},
  {id: 5, name: "Mente de Millonaria", category: "podcast", value: 54000000, active: true},
];
...
const formatItem = (item) => {
  ...
  return `🎧${item.name} [${item.category}] - ${VALUE_LABEL}: ${item.value}`; // TODO: Expandir este template
...
// const isValid = (member) => member.active === true;
 ...
 const isValid = (item) => item.active && item.value > 1000;
