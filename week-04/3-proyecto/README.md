...
```
=============================================
  APP DE MÚSICA Y PODCASTS — FICHA DE ENTIDAD
=============================================
Nombre:      PODCAST PREMIUM EXCLUSIVO
Categoría:   Podcast
Código:      POD-001
Prefijo:     POD
Valor:       15000
...
---------------------------------------------
Descripción:
Podcast exclusivo sobre tecnología, música digital y tendencias del streaming.
=============================================

--- Validaciones ---
¿Código empieza con 'POD'?: true
¿Descripción contiene 'música'?: true
¿Código termina con '001'?: true

--- Notificación ---
📢 Nuevo contenido disponible: Podcast Premium Exclusivo (POD-001)
```
